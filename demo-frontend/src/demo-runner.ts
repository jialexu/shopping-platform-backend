import { ShoppingServiceAPI } from './api';
import { DemoStep } from './types';

export class DemoRunner {
  private api: ShoppingServiceAPI;
  private steps: DemoStep[] = [];
  private onStepUpdate?: (steps: DemoStep[]) => void;

  constructor(onStepUpdate?: (steps: DemoStep[]) => void) {
    this.api = new ShoppingServiceAPI();
  ...
  private updateStep(stepId: number, update: Partial<DemoStep>): void {
